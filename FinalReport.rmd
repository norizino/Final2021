...
$H_0$ the alternative hypothesis is that the vaccine in fact does make a difference in weather or not a Female contracts Covid-19.
...
The Chi Squared table shows that the P-Value is a small number of 0.002273 is so small that it is highly unlikely that the results are by chance. 

$H_0$ the null hypothesis given taking the vaccine there is no difference of weather or not a DrugUsers contract Covid-19. 

$H_0$ the alternative hypothesis is that the vaccine in fact does make a difference in weather or not a DrugUsers contract Covid-19. 
